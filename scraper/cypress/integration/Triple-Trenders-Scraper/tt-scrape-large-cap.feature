Feature: Daily Barchart Sdvances / Declines Scraper
    ...
    Scenario: Scraping Barchart Trenders Info
        ...
        When I navigate to the "large-cap_trenders_5d_main-view" page
        And I scrape the "large_cap_us" "trenders" for "5d" on the "main-view", new data: "true"

        When I navigate to the "large-cap_trenders_5d_technical-view" page
        And I scrape the "large_cap_us" "trenders" for "5d" on the "technical-view", new data: "false"

        Then I update the database's bc scrape object for "large_cap_us" "trenders" "5d"
        ...
        When I navigate to the "large-cap_trenders_1m_main-view" page
        And I scrape the "large_cap_us" "trenders" for "1m" on the "main-view", new data: "true"

        When I navigate to the "large-cap_trenders_1m_technical-view" page
        And I scrape the "large_cap_us" "trenders" for "1m" on the "technical-view", new data: "false"

        Then I update the database's bc scrape object for "large_cap_us" "trenders" "1m"
