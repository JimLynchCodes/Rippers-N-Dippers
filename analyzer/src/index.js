...
const fillInRankings = require('./rankings/rankings-filler').fillInRankings
...
const main2 = async () => {
    ...
    return new Promise(async resolve => {
        ...
        // const keyStatsList = await iexCaller.getKeyStatsList(uniqueSymbols)
        ...
        const tt_stats = {
            trending_upwards: fillInRankings(ttStatsWithoutRankings.trending_upwards),
            trending_downwards: fillInRankings(ttStatsWithoutRankings.trending_downwards)
        }
            
        console.log('tt_stats are: ', tt_stats)
