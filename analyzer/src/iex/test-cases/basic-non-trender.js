...
const nonTrenderIexInput = {
    AFI: {
        stats: {
            ...
            month3ChangePercent: -0.10427807486631013,
...
const nonTrenderTtResult = [{"dip_percentage": -0.09, "market_cap_group": "Micro", "pe_ratio": -1.29, "symbol": "AFI", "volume_ratio": 1.03, "trend_rate": "N/T"}]
